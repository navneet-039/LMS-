...
function Home() {
  return (
    <div>
      ...
      {/* {section3} */}
      <div className="w-11/12 mx-auto max-w-maxContent items-center  flex flex-col justify-between gap-8 bg-richblack-900 text-white">
